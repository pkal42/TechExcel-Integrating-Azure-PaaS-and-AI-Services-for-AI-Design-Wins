...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get bookings for a single hotel for stays starting from the given begin date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The stay begin date at the hotel")] DateTime dt)
    {
